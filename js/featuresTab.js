...
function updateTab(tabId) {
   ...
   if (tabId == 1) tab = createTab(
      "https://github.com/devsimocastles/bookmark-landing-page/blob/main/images/illustration-features-tab-1.svg",
      "Bookmark in one click",
      "Organize your bookmarks however you like. Our simple drag-and-drop interface gives you complete control over how you manage your favourite sites");
   if (tabId== 2) tab = createTab(
      "https://github.com/devsimocastles/bookmark-landing-page/blob/main/images/illustration-features-tab-2.svg",
      "Intelligent search", 
